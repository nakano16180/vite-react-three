...
const jsonComplete =
  legacyComplete || (await metadataValue("legacy_strokes_json_migrated")) === "true";
const spatialComplete =
  legacyComplete || (await metadataValue("legacy_strokes_spatial_migrated")) === "true";
```
